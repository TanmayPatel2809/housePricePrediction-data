...
SERVICE_NAME = app
CONTAINER_NAME = housepriceprediction-data-container

DIRS_TO_VALIDATE = housePricePrediction
...
## version data
version-data: up
	$(DOCKER_COMPOSE_EXEC) python ./housePricePrediction/version_data.py
